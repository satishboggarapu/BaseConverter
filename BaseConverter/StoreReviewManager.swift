...
class StoreReviewManager {
    ...
    private let minimumUnscrambledWordsCount = 50
    ...
    private var totalOperations: Int {
        get {
            UserDefaults.standard.integer(forKey: UserDefaultsKeys.totalOperations.rawValue)
        }
    }
